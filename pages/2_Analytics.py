...
if len(history) == 0:
    ...
    st.warning(
        "Run change detection first from Dashboard."
    )
    ...
    st.info(
        "Run more image analyses to generate historical trends and comparison graphs."
    )
    ...
    ax.set_ylabel("Changed Area (%)")
    ax.set_title("Satellite Change Detection History")
